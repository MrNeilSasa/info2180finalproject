...
create table Contacts (id INTEGER(20), title VARCHAR(20),firstname VARCHAR(20), lastname VARCHAR(20), email VARCHAR(30), telephone VARCHAR(20), company VARCHAR(20), assigned_to VARCHAR(20), creator_id INTEGER(20), created_by INTEGER(20), created_at DATETIME, updated_at DATETIME);
